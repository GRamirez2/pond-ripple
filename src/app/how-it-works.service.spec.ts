...
describe('HowItWorksService', () => {
  ...
  beforeEach(() => {
    ...
    service = new HowItWorksService(httpClientSpy as any);
  });

  it('should return expected datas (HttpClient called once)', () => {
    const expectedData =
    [
      {
    ...
    expect(httpClientSpy.get.calls.count()).toBe(1, ' call');
  });
