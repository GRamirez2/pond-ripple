...
describe('FooterComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      {provide: HowItWorksService, useClass: MockApiData}],
    });
    comp = TestBed.inject(FooterComponent);
    userService = TestBed.inject(HowItWorksService);
  }));

  it('$cleanData should be undefined before onInit', () => {
    expect(comp.$cleanData).toBeUndefined();
  });

  it('$cleanData should have sorted and redcued api data after sortReduceForUI function is called ', () => {
    comp.saveUpdatedData(apiData)
    expect(comp.$cleanData).toEqual(mockSortedAndReducedData);
  });  
